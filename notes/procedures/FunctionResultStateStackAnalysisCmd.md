...
Wraps Ghidra's `ghidra.app.cmd.function.FunctionResultStateStackAnalysisCmd`. Mutating: the file is checked out
...
## Example
```json
{"procedure": "FunctionResultStateStackAnalysisCmd", "file": "/Mapeditor.exe", "address": "0x401000"}
```
